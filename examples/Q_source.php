...
$hl->getField('subjects')->setSimplePrefix('<u>')->setSimplePostfix('</u>');
$hl->getField('publisher')->setSimplePrefix('<u>')->setSimplePostfix('</u>');
$hl->getField('descriptions')->setSimplePrefix('<i>')->setSimplePostfix('</i>');
